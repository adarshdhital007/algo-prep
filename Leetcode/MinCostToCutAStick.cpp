...
public:
    ...
    int calculateCost(int left, int right){
        ...
        for(int mid=left+1;mid<right;mid++){
            int currCost=calculateCost(left,mid)+calculateCost(mid,right)+newCuts[right]-newCuts[left];
    ...
    int minCost(int n, vector<int>& cuts) {
        ...
        return calculateCost(0,newCuts.size()-1);
    }
};
